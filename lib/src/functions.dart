...
getTextStyle(BlockTextStyle textStyle, BuildContext context) {
  return getGoogleFont(textStyle.fontFamily).copyWith(
    fontFamily: "Tajawal",
    color: Theme.of(context).brightness == Brightness.dark ? Colors.white : textStyle.color,
