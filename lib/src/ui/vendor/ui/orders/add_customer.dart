...
final Order order;
   AddCustomer({Key? key, required this.vendorBloc, required this.order}) : super(key: key);
...
class _AddCustomerState extends State<AddCustomer> {
  ...
  final billing = Address(firstName: '', lastName: '', company: '', address1: '', address2: '', city: '', postcode: '', country: '', state: '', email: '', phone: '');
  final shipping = Address(firstName: '', lastName: '', company: '', address1: '', address2: '', city: '', postcode: '', country: '', state: '', email: '', phone: '');
  List<Region> regions = [];
