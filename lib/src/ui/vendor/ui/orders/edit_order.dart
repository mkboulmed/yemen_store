...
class EditOrder extends StatefulWidget {
  ...
  EditOrder({Key? key, required this.vendorBloc, required this.order})
      : super(key: key);
  @override
...
class _EditOrderState extends State<EditOrder> {
  ...
  Address billing = Address(firstName: '', lastName: '', company: '', address1: '', address2: '', city: '', postcode: '', country: '', state: '', email: '', phone: '');
  Address shipping = Address(firstName: '', lastName: '', company: '', address1: '', address2: '', city: '', postcode: '', country: '', state: '', email: '', phone: '');
  List<Region> regions = [];
            ...
            children: <Widget>[
              ...
              TextFormField(
                ...
                onSaved: (val) =>
                    setState(() {
                      if(val != null)
                      widget.order.billing.company = val;
                    }),
              ),
              TextFormField(
              ...
              TextFormField(
                ...
                onSaved: (val) {
                  if(val != null)
                  setState(() {
                      widget.order.billing.address2 = val;
                    });
                },
              ),
              TextFormField(
              ...
              TextFormField(
                ...
                onSaved: (val) {
                  if(val != null)
                  setState(() {
                      widget.order.billing.postcode = val;
                    });
                },
              ),
              TextFormField(
              ...
              regions.isNotEmpty ? Column(
                ...
                onSaved: (val) {
                  if(val != null)
                  setState(() => widget.vendorBloc.formData['billing_state'] = val);
                },
              ),
              SizedBox(
                height: 24.0,
