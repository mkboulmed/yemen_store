...
import 'package:app/src/ui/blocks/banners/button_grid.dart';
import 'package:app/src/ui/blocks/banners/button_list.dart';
...
import 'package:app/src/ui/blocks/icons/icons_grid.dart';
import 'package:app/src/ui/blocks/icons/icons_scroll.dart';
import 'package:app/src/ui/blocks/list_tile/list_tile.dart';
...
class SliverBlock extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    switch (block.blockType) {
      ...
      case BlockType.iconsGrid:
        return IconsGrid(block: block);
      case BlockType.iconsScroll:
        return IconsScroll(block: block);
      case BlockType.buttonList:
        return ButtonList(block: block);
      case BlockType.buttonGrid:
        return ButtonGrid(block: block);
      case BlockType.listTile:
        return ListTileItems(block: block);
