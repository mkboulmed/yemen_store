...
class BannerTopSlider extends StatefulWidget {
  final Block block;
  BannerTopSlider({Key? key, required this.block}) : super(key: key);
  @override
...
class CurvedPainter extends CustomPainter {
  ...
  CurvedPainter({Key? key, required this.context});

@override
void paint(Canvas canvas, Size size) {
  var paint = Paint();
  paint.color = Theme.of(context).brightness == Brightness.dark ? Colors.black : Colors.white;
