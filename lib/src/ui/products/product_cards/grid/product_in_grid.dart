                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Padding(
                                      ...
                                      child: Text(parseHtmlString(widget.product.name), maxLines: 2, style: Theme.of(context).textTheme.bodyText2,),
                                    ),
                                    SizedBox(height: 4),
                                              ...
                                              child: OutlinedButton(
                                                child: Padding(
                                                  ...
                                                  child: Row(
                                                    ...
                                                    children: [
                                                      Expanded(child: Text(getTitle(_selectedVariation!), style: _textStyle, maxLines: 1,)),
