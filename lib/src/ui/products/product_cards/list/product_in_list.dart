...
class ProductInList extends StatefulWidget {
  final Product product;

  const ProductInList({Key? key, required this.product}) : super(key: key);
  @override
  _ProductInListState createState() => _ProductInListState();
}

class _ProductInListState extends State<ProductInList> {
        ...
        builder: (context, child, model) {
          return Stack(
            children: [
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Row(
                                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                  children: [
                                    if(widget.product.tags.contains('fresh')) Padding(
                                    ...
                                    if(widget.product.tags.contains('express')) Padding(
                                      padding: const EdgeInsets.fromLTRB(0, 8, 0, 8),
                                      child: Container(
                                        height: 18,
                                        padding: EdgeInsets.fromLTRB(8, 4, 8, 4),
              ...
              Positioned(right: 4, bottom: 0, child: WishListIcon(id: widget.product.id, color: Theme.of(context).brightness == Brightness.dark ? Colors.white60 : null,))
            ],
          );
        }
    );
