...
class ProductGrid extends StatefulWidget {
  ...
  final WishListBloc wishListBloc;
  const ProductGrid({Key? key, required this.products, required this.wishListBloc}) : super(key: key);
  @override
          ...
          children: <Widget>[
                        ...
                        child: Container(
                          ...
                          child: Text(
                            ...
                            style: Theme.of(context).textTheme.bodyMedium!
                                .copyWith(fontSize: 12.0, color: Theme.of(context).colorScheme.onSecondary),
                          ),
                        ),
                      )
                          : Container(),
            ...
            Expanded(
              child: Container(
                ...
                height: 130,
                child: Padding(
                  padding: const EdgeInsets.fromLTRB(16.0, 4.0, 4, 4.0),
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      Row(
                        ...
                        children: [
                          IconButton(
                            onPressed: () {
                              wishListBloc.removeItemFromWishList(product.id);
                              context.read<Favourites>().removeFromWishList(product.id);
                            },
                            icon: Icon(
                              Icons.delete,
                              size: 22,
