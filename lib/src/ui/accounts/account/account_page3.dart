...
class AccountPage3 extends StatefulWidget {
  @override
  _AccountPage3State createState() => _AccountPage3State();
}
                ...
                children: [
                  ListTile(
                    ...
                    trailing: accountGroup.menuItems[index].trailing.isNotEmpty
                        ? DunesIcon(iconString: accountGroup.menuItems[index].trailing, color: Theme.of(context).brightness == Brightness.light ? Color(0xff8a8a8d) : null,)
                        : null,
                    title: Text(accountGroup.menuItems[index].title, style: Theme.of(context).textTheme.headlineSmall!.copyWith(
                        fontWeight: FontWeight.bold,
                        fontSize: 16,
                        letterSpacing: 0.7
                    )),
                    subtitle: accountGroup.menuItems[index].description.isNotEmpty ? Text(accountGroup.menuItems[index].description, style: Theme.of(context).textTheme.bodyMedium!.copyWith(
                        color: Theme.of(context).brightness == Brightness.light ? Color(0xff8a8a8d) : null,
                        letterSpacing: 0
                    )) : null,
                  ),
