    ...
    return Scaffold(
      ...
      body: context.watch<ShoppingCart>().cart.cartContents.length > 0 ? Builder(
        builder: (context) {
          ...
          child: Center(
            child: DunesIcon(iconString: widget.appStateModel.blocks.settings.cartIcon, size: 150, color: Theme.of(context).focusColor),
          )),
                ...
                onPressed: () async {
                  if (widget.appStateModel.blocks.settings.webViewCheckout) {
                    ...
                    Navigator.push(
                        ...
                        MaterialPageRoute(
                            builder: (context) =>
                                CheckoutForm(checkoutFormBloc: checkoutBloc)));
          ...
          child: Container(
            ...
            child: Form(
              ...
              child: TextFormField(
                ...
                onSaved: (value) {
                  if(value != null)
                  checkoutBloc.formData['coupon_code'] = value;
                },
              ),
            ),
          ),
    ...
    return Column(
      children: [
        ListTile(
          ...
          title: Text(parseHtmlString(widget.product.name), maxLines: 2, style: Theme.of(context).textTheme.subtitle2!.copyWith(
            fontSize: 18,
          )),
          subtitle: Column(
