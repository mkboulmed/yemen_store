...
class GroupsModel {
  ...
  factory GroupsModel.fromJson(Map<String, dynamic> json) => GroupsModel(
    id: json["id"] == null ? 0 : json["id"],
    title: json["title"] == null ? 'New' : json["title"],
    description: json["description"] == null ? 'Description goes here' : json["description"],
    menuGroup: _nullOrEmptyOrFalse(json["menuGroup"]) ? [] : List<MenuGroup>.from(json["menuGroup"].map((x) => MenuGroup.fromJson(x))),
    floatingAction: json["floatingAction"] == null ? null : Child.fromJson(json["floatingAction"]),
    actions: json["actions"] == null ? [] : List<Child>.from(json["actions"].map((x) => Child.fromJson(x))),
    blockTheme: _nullOrEmptyOrFalse(json["blockTheme"]) ? BlockThemes.fromJson({}) : BlockThemes.fromJson(json["blockTheme"]),
  );
