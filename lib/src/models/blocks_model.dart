...
class Settings {
  ...
  ProgressIndicatorSettings progressIndicator;
  String iosShareAppLink;
  String productCard;
  bool relatedProductScroll;
  double relatedProductHeight;
  String cartIcon;
  String searchIcon;
  String wishListIcon;
  String wishListIconFilled;
  bool? showIntro;
  ...
  Settings({
    ...
    required this.iosShareAppLink,
    required this.productCard,
    required this.relatedProductScroll,
    required this.relatedProductHeight,
    required this.cartIcon,
    required this.searchIcon,
    required this.wishListIcon,
    required this.wishListIconFilled,
    this.showIntro,
  });
  ...
  factory Settings.fromJson(Map<String, dynamic> json) => Settings(
    ...
    customAccount: json["customAccount"] == true ? true : false,
    ...
    splashDuration: json["splashDuration"] is int ? json["splashDuration"] : 0,
    progressIndicator: json["progressIndicator"] == null ? ProgressIndicatorSettings.fromJson({}) : ProgressIndicatorSettings.fromJson(json["progressIndicator"]),
    iosShareAppLink: json["iosShareAppLink"] == null ? '' : json["iosShareAppLink"],
    productCard: json["productCard"] == null ? 'STYLE1' : json["productCard"],
    relatedProductScroll: json["relatedProductScroll"] == true ? true : false,
    relatedProductHeight: json["relatedProductHeight"] == null ? 380 : double.parse(json["relatedProductHeight"].toString()),
    cartIcon: json["cartIcon"] == null ? 'FlutterRemix.shopping_cart_line' : json["cartIcon"],
    searchIcon: json["searchIcon"] == null ? 'FlutterRemix.search_2_line' : json["searchIcon"],
    wishListIcon: json["wishListIcon"] == null ? 'CupertinoIcons.heart' : json["wishListIcon"],
    wishListIconFilled: json["wishListIconFilled"] == null ? 'CupertinoIcons.heart_fill' : json["wishListIconFilled"],
    showIntro: json["showIntro"] == true ? true : false,
  );
}
...
class ProgressIndicatorSettings {
  ...
  factory ProgressIndicatorSettings.fromJson(Map<String, dynamic> json) => ProgressIndicatorSettings(
    type: _nullOrEmptyOrFalse(json["type"]) ? null : json["type"],
    primaryColor: _nullOrEmptyOrFalse(json["primaryColor"]) ? null : HexColor(json["primaryColor"]),
    secondaryColor: _nullOrEmptyOrFalse(json["secondaryColor"]) ? null : HexColor(json["secondaryColor"]),
    width: _nullOrEmptyOrFalse(json["width"]) ? 4 : double.parse(json["width"].toString()),
    size: _nullOrEmptyOrFalse(json["size"]) ? 40 : double.parse(json["size"].toString()),
  );

  Map<String, dynamic> toJson() => {
    "type": type,
    "primaryColor": primaryColor != null ? toHexColor(primaryColor!) : null,
    "secondaryColor": secondaryColor != null ? toHexColor(secondaryColor!) : null,
    "width": width,
    "size": size
  };
}
...
class AppBarStyle {
  ...
  factory AppBarStyle.fromJson(Map<String, dynamic> json) => AppBarStyle(
    ...
    wishListIcon: json["wishListIcon"] == null ? false : json["wishListIcon"],
...
class LocaleText {
  ...
  factory LocaleText.fromJson(Map<String, dynamic> json) => LocaleText(
    ...
    view: json["View"] == null ?"View": json["View"],
    productNotFound: json["Product not found"] == null ?"Product not found!": json["Product not found"],
  );
}
...
class Block {
  ...
  factory Block.fromJson(Map<String, dynamic> json) => Block(
    ...
    textStyle: json["textStyle"] == null ? null : BlockTextStyle.fromJson(json["textStyle"]),
    titleStyle: json["titleStyle"] == null ? null : BlockTextStyle.fromJson(json["titleStyle"]),
    blockSettings: json["blockSettings"] == null ? BlockSettings.fromJson({}) : BlockSettings.fromJson(json["blockSettings"]),
  );
}
...
class BlockSettings {
  BlockSettings({
    ...
    required this.swiperPagination,
    required this.swiperLayout,
    required this.pagination,
    required this.totalRepeatCount,
    required this.displayFullTextOnTap,
  ...
  factory BlockSettings.fromJson([Map<String, dynamic>? json]) {
    ...
    return BlockSettings(
      viewportFraction: _nullOrEmptyOrFalse(json['viewportFraction']) ? 1.0 : double.parse(json['viewportFraction'].toString()),
      fade: _nullOrEmptyOrFalse(json['fade']) ? 1 : double.parse(json['fade'].toString()),
      autoplayDelay: _nullOrEmptyOrFalse(json['autoplayDelay']) ? 70000 : int.parse(json['autoplayDelay'].toString()),
      autoplay: json['autoplay'] == false ? false : true,
      control: json['control'] == true ? true : false,
      loop: json['loop'] == false ? false : true,
      alignment: _nullOrEmptyOrFalse(json["alignment"]) ? Alignment.bottomCenter : getAlignment(json["alignment"]),
      indicatorLayout: _nullOrEmptyOrFalse(json["indicatorLayout"]) ? PageIndicatorLayout.NONE : getIndicatorLayout(json["indicatorLayout"]),
      swiperPagination: json['swiperPagination'] == 'SwiperPagination.fraction' ? SwiperPagination.fraction : SwiperPagination.dots,
      swiperLayout: _nullOrEmptyOrFalse(json["swiperLayout"]) ? SwiperLayout.DEFAULT : getSwiperLayout(json["swiperLayout"]),
      pagination: json['pagination'] == null ? 'STYLE1' : json['pagination'],
      textAnimationType: json['type'] == null ? 'FadeAnimatedText' : json['type'],
      totalRepeatCount: _nullOrEmptyOrFalse(json['totalRepeatCount']) ? 4 : int.parse(json['totalRepeatCount'].toString()),
      displayFullTextOnTap: json['displayFullTextOnTap'] == false ? false : true,
      stopPauseOnTap: json['stopPauseOnTap'] == false ? false : true,
      repeatForever: json['repeatForever'] == false ? false : true,
      speed: _nullOrEmptyOrFalse(json['speed']) ? 2000 : int.parse(json['speed'].toString()),
      colorizeColors: json["colorizeColors"] == null ? [
        Colors.purple,
        Colors.blue,
        Colors.yellow,
        Colors.red,
      ] : List<Color>.from(json["colorizeColors"].map((x) => HexColor(x))),
    );
  }
  ...
  Map<String, dynamic> toJson() => {
    ...
    'fade': fade.toDouble(),
    'autoplayDelay': autoplayDelay.toDouble(),
    'indicatorLayout': indicatorLayout.toString(),
    'control': control,
    'loop': loop,
    'autoplay': autoplay,
    'alignment': alignment.toString(),
    'swiperPagination': swiperPagination.toString(),
  };
}

SwiperLayout getSwiperLayout(String swiperLayout) {
  switch (swiperLayout) {
    case 'SwiperLayout.STACK':
      return SwiperLayout.STACK;
    case 'SwiperLayout.TINDER':
      return SwiperLayout.TINDER;
    case 'SwiperLayout.CUSTOM':
      return SwiperLayout.CUSTOM;
    case 'SwiperLayout.DEFAULT':
      return SwiperLayout.DEFAULT;
    default:
      return SwiperLayout.DEFAULT;
  }
}

PageIndicatorLayout getIndicatorLayout(String indicatorLayout) {
  switch (indicatorLayout) {
    case 'PageIndicatorLayout.WARM':
      return PageIndicatorLayout.WARM;
    case 'PageIndicatorLayout.SCALE':
      return PageIndicatorLayout.SCALE;
    case 'PageIndicatorLayout.SLIDE':
      return PageIndicatorLayout.SLIDE;
    case 'PageIndicatorLayout.COLOR':
      return PageIndicatorLayout.COLOR;
    case 'PageIndicatorLayout.DROP':
      return PageIndicatorLayout.DROP;
    default:
      return PageIndicatorLayout.NONE;
  }
}
...
enum BlockType { bannerList, bannerGrid, bannerScroll, bannerSlider, categoryList, categoryGrid, categoryScroll, categorySlider, storeList, storeScroll, storeListTile, storeSlider,
  ...
  postList, postScroll, postListTile, postSlider, bannerPresets, textList, htmlList, videoList, videoListWithController, youTubeVideo, iconsGrid, iconsScroll, listTile, buttonList, buttonGrid}
...
final blockTypeValues = EnumValues({
  ...
  "iconsGrid": BlockType.iconsGrid,
  "iconsScroll": BlockType.iconsScroll,
  "listTile": BlockType.listTile,
  "buttonList": BlockType.buttonList,
  "buttonGrid": BlockType.buttonGrid
});
...
class Child {
  ...
  factory Child.fromJson(Map<String, dynamic> json) => Child(
    ...
    buttonStyle: _nullOrEmptyOrFalse(json['buttonStyle']) ? null : ChildButtonStyle.fromJson(json["buttonStyle"]),
  );
}

class ChildButtonStyle {
  ChildButtonStyle({
  ...
  factory ChildButtonStyle.fromJson(Map<String, dynamic> json) => ChildButtonStyle(
    foregroundColor: json["foregroundColor"] == null ? Colors.white : HexColor(json["foregroundColor"]),
    backgroundColor: json["backgroundColor"] == null ? Colors.deepOrange : HexColor(json["backgroundColor"]),
    shadowColor: json["shadowColor"] == null ? Colors.white : HexColor(json["shadowColor"]),
    surfaceTintColor: json["surfaceTintColor"] == null ? Colors.deepOrange : HexColor(json["surfaceTintColor"]),
    ...
    padding: json["padding"] == null ? 10.0 : double.parse(json["padding"].toString()),
    style: json["style"] == null ? null : json["style"],
  );

  Map<String, dynamic> toJson() => {
    "foregroundColor": foregroundColor ?? toHexColor(foregroundColor!),
    "backgroundColor": backgroundColor ?? toHexColor(backgroundColor!),
    "shadowColor": shadowColor ?? toHexColor(shadowColor!),
    "surfaceTintColor": surfaceTintColor ?? toHexColor(surfaceTintColor!),
...
class PageLayout {
  ...
  factory PageLayout.fromJson(Map<String, dynamic> json) => PageLayout(
    ...
    introScreen: json["introScreen"] == null ? 'layout1' : json["introScreen"],
  );
}
