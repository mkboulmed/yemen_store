...
class StoreModel {
  ...
  factory StoreModel.fromJson(Map<String, dynamic> json) => StoreModel(
    ...
    //address: (json["address"] == null || json["address"] is String) ? Address.fromJson({}) : Address.fromJson(json["address"]),
    addressLine: json["address_line"] == null ? null : json["address_line"],
    ...
    bookable: _nullOrEmptyOrFalse(json["bookable_products"]) ? [] : List<Product>.from(json["bookable_products"].map((x) => Product.fromJson(x))),
  );
